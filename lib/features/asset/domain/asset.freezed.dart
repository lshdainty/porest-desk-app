...
/// 날짜의 전달 1일~말일이고, 그 뒤 회차는 지금 [paymentDay] 로 결제된다. 결제일 없는
/// 카드·신용카드가 아닌 자산·옛 서버면 null 이다(그때는 [paymentDay] 로만 센다).
 String? get nextPaymentDate;/// 신용카드: **이 날짜(`yyyy-MM-dd`) 이하 거래는 결제가 끝난(닫힌) 회차**다.
///
