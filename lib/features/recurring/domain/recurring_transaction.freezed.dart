...
mixin _$RecurringTransaction {
 ...
 int get rowId; int? get userRowId; int get categoryRowId; String? get categoryName; int get assetRowId; String? get assetName;/// 이체일 때 받는 자산. 지출·수입이면 null.
 int? get toAssetRowId; String? get toAssetName;/// 이체 수수료. 지출·수입이면 null.
 int? get fee;/// 이체 이자 — 받는 자산이 대출일 때만 값이 있다.
 int? get interestAmount; int? get sourceExpenseRowId; String get expenseType; int get amount; String? get description; String? get merchant; String? get paymentMethod; String get frequency; int? get intervalValue; int? get dayOfWeek; int? get dayOfMonth; String? get executionTime;// 'HH:mm:ss' — 실행분을 만들 시각 [userClock]
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,rowId,userRowId,categoryRowId,categoryName,assetRowId,assetName,toAssetRowId,toAssetName,fee,interestAmount,sourceExpenseRowId,expenseType,amount,description,merchant,paymentMethod,frequency,intervalValue,dayOfWeek,dayOfMonth,executionTime,startDate,endDate,maxOccurrences,executedCount,nextExecutionDate,lastExecutedAt,isActive,autoLog,notifyDayBefore]);

@override
String toString() {
  return 'RecurringTransaction(rowId: $rowId, userRowId: $userRowId, categoryRowId: $categoryRowId, categoryName: $categoryName, assetRowId: $assetRowId, assetName: $assetName, toAssetRowId: $toAssetRowId, toAssetName: $toAssetName, fee: $fee, interestAmount: $interestAmount, sourceExpenseRowId: $sourceExpenseRowId, expenseType: $expenseType, amount: $amount, description: $description, merchant: $merchant, paymentMethod: $paymentMethod, frequency: $frequency, intervalValue: $intervalValue, dayOfWeek: $dayOfWeek, dayOfMonth: $dayOfMonth, executionTime: $executionTime, startDate: $startDate, endDate: $endDate, maxOccurrences: $maxOccurrences, executedCount: $executedCount, nextExecutionDate: $nextExecutionDate, lastExecutedAt: $lastExecutedAt, isActive: $isActive, autoLog: $autoLog, notifyDayBefore: $notifyDayBefore)';
}
...
@useResult
$Res call({
 int rowId, int? userRowId, int categoryRowId, String? categoryName, int assetRowId, String? assetName, int? toAssetRowId, String? toAssetName, int? fee, int? interestAmount, int? sourceExpenseRowId, String expenseType, int amount, String? description, String? merchant, String? paymentMethod, String frequency, int? intervalValue, int? dayOfWeek, int? dayOfMonth, String? executionTime, String? startDate, String? endDate, int? maxOccurrences, int executedCount, String? nextExecutionDate, String? lastExecutedAt, String? isActive, bool autoLog, bool notifyDayBefore
});
...
/// Create a copy of RecurringTransaction
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? rowId = null,Object? userRowId = freezed,Object? categoryRowId = null,Object? categoryName = freezed,Object? assetRowId = null,Object? assetName = freezed,Object? toAssetRowId = freezed,Object? toAssetName = freezed,Object? fee = freezed,Object? interestAmount = freezed,Object? sourceExpenseRowId = freezed,Object? expenseType = null,Object? amount = null,Object? description = freezed,Object? merchant = freezed,Object? paymentMethod = freezed,Object? frequency = null,Object? intervalValue = freezed,Object? dayOfWeek = freezed,Object? dayOfMonth = freezed,Object? executionTime = freezed,Object? startDate = freezed,Object? endDate = freezed,Object? maxOccurrences = freezed,Object? executedCount = null,Object? nextExecutionDate = freezed,Object? lastExecutedAt = freezed,Object? isActive = freezed,Object? autoLog = null,Object? notifyDayBefore = null,}) {
...
as int?,executionTime: freezed == executionTime ? _self.executionTime : executionTime // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int rowId,  int? userRowId,  int categoryRowId,  String? categoryName,  int assetRowId,  String? assetName,  int? toAssetRowId,  String? toAssetName,  int? fee,  int? interestAmount,  int? sourceExpenseRowId,  String expenseType,  int amount,  String? description,  String? merchant,  String? paymentMethod,  String frequency,  int? intervalValue,  int? dayOfWeek,  int? dayOfMonth,  String? executionTime,  String? startDate,  String? endDate,  int? maxOccurrences,  int executedCount,  String? nextExecutionDate,  String? lastExecutedAt,  String? isActive,  bool autoLog,  bool notifyDayBefore)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecurringTransaction() when $default != null:
return $default(_that.rowId,_that.userRowId,_that.categoryRowId,_that.categoryName,_that.assetRowId,_that.assetName,_that.toAssetRowId,_that.toAssetName,_that.fee,_that.interestAmount,_that.sourceExpenseRowId,_that.expenseType,_that.amount,_that.description,_that.merchant,_that.paymentMethod,_that.frequency,_that.intervalValue,_that.dayOfWeek,_that.dayOfMonth,_that.executionTime,_that.startDate,_that.endDate,_that.maxOccurrences,_that.executedCount,_that.nextExecutionDate,_that.lastExecutedAt,_that.isActive,_that.autoLog,_that.notifyDayBefore);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int rowId,  int? userRowId,  int categoryRowId,  String? categoryName,  int assetRowId,  String? assetName,  int? toAssetRowId,  String? toAssetName,  int? fee,  int? interestAmount,  int? sourceExpenseRowId,  String expenseType,  int amount,  String? description,  String? merchant,  String? paymentMethod,  String frequency,  int? intervalValue,  int? dayOfWeek,  int? dayOfMonth,  String? executionTime,  String? startDate,  String? endDate,  int? maxOccurrences,  int executedCount,  String? nextExecutionDate,  String? lastExecutedAt,  String? isActive,  bool autoLog,  bool notifyDayBefore)  $default,) {final _that = this;
switch (_that) {
case _RecurringTransaction():
return $default(_that.rowId,_that.userRowId,_that.categoryRowId,_that.categoryName,_that.assetRowId,_that.assetName,_that.toAssetRowId,_that.toAssetName,_that.fee,_that.interestAmount,_that.sourceExpenseRowId,_that.expenseType,_that.amount,_that.description,_that.merchant,_that.paymentMethod,_that.frequency,_that.intervalValue,_that.dayOfWeek,_that.dayOfMonth,_that.executionTime,_that.startDate,_that.endDate,_that.maxOccurrences,_that.executedCount,_that.nextExecutionDate,_that.lastExecutedAt,_that.isActive,_that.autoLog,_that.notifyDayBefore);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int rowId,  int? userRowId,  int categoryRowId,  String? categoryName,  int assetRowId,  String? assetName,  int? toAssetRowId,  String? toAssetName,  int? fee,  int? interestAmount,  int? sourceExpenseRowId,  String expenseType,  int amount,  String? description,  String? merchant,  String? paymentMethod,  String frequency,  int? intervalValue,  int? dayOfWeek,  int? dayOfMonth,  String? executionTime,  String? startDate,  String? endDate,  int? maxOccurrences,  int executedCount,  String? nextExecutionDate,  String? lastExecutedAt,  String? isActive,  bool autoLog,  bool notifyDayBefore)?  $default,) {final _that = this;
switch (_that) {
case _RecurringTransaction() when $default != null:
return $default(_that.rowId,_that.userRowId,_that.categoryRowId,_that.categoryName,_that.assetRowId,_that.assetName,_that.toAssetRowId,_that.toAssetName,_that.fee,_that.interestAmount,_that.sourceExpenseRowId,_that.expenseType,_that.amount,_that.description,_that.merchant,_that.paymentMethod,_that.frequency,_that.intervalValue,_that.dayOfWeek,_that.dayOfMonth,_that.executionTime,_that.startDate,_that.endDate,_that.maxOccurrences,_that.executedCount,_that.nextExecutionDate,_that.lastExecutedAt,_that.isActive,_that.autoLog,_that.notifyDayBefore);case _:
  return null;
...
class _RecurringTransaction implements RecurringTransaction {
  const _RecurringTransaction({required this.rowId, this.userRowId, this.categoryRowId = 0, this.categoryName, this.assetRowId = 0, this.assetName, this.toAssetRowId, this.toAssetName, this.fee, this.interestAmount, this.sourceExpenseRowId, required this.expenseType, this.amount = 0, this.description, this.merchant, this.paymentMethod, required this.frequency, this.intervalValue, this.dayOfWeek, this.dayOfMonth, this.executionTime, this.startDate, this.endDate, this.maxOccurrences, this.executedCount = 0, this.nextExecutionDate, this.lastExecutedAt, this.isActive, this.autoLog = false, this.notifyDayBefore = false});
...
@override final  String? executionTime;
