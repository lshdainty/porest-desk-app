...
mixin _$CalendarEvent {
 ...
 int? get labelRowId; String? get labelName; String? get labelColor; String? get location; String? get rrule; int? get groupRowId; String? get groupName;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,rowId,userRowId,title,description,eventType,color,startDate,endDate,isAllDay,labelRowId,labelName,labelColor,location,rrule,groupRowId,groupName);

@override
String toString() {
  return 'CalendarEvent(rowId: $rowId, userRowId: $userRowId, title: $title, description: $description, eventType: $eventType, color: $color, startDate: $startDate, endDate: $endDate, isAllDay: $isAllDay, labelRowId: $labelRowId, labelName: $labelName, labelColor: $labelColor, location: $location, rrule: $rrule, groupRowId: $groupRowId, groupName: $groupName)';
}
...
@useResult
$Res call({
 int rowId, int? userRowId, String title, String? description, String? eventType, String? color, String startDate, String endDate, String? isAllDay, int? labelRowId, String? labelName, String? labelColor, String? location, String? rrule, int? groupRowId, String? groupName
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int rowId,  int? userRowId,  String title,  String? description,  String? eventType,  String? color,  String startDate,  String endDate,  String? isAllDay,  int? labelRowId,  String? labelName,  String? labelColor,  String? location,  String? rrule,  int? groupRowId,  String? groupName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CalendarEvent() when $default != null:
return $default(_that.rowId,_that.userRowId,_that.title,_that.description,_that.eventType,_that.color,_that.startDate,_that.endDate,_that.isAllDay,_that.labelRowId,_that.labelName,_that.labelColor,_that.location,_that.rrule,_that.groupRowId,_that.groupName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int rowId,  int? userRowId,  String title,  String? description,  String? eventType,  String? color,  String startDate,  String endDate,  String? isAllDay,  int? labelRowId,  String? labelName,  String? labelColor,  String? location,  String? rrule,  int? groupRowId,  String? groupName)  $default,) {final _that = this;
switch (_that) {
case _CalendarEvent():
return $default(_that.rowId,_that.userRowId,_that.title,_that.description,_that.eventType,_that.color,_that.startDate,_that.endDate,_that.isAllDay,_that.labelRowId,_that.labelName,_that.labelColor,_that.location,_that.rrule,_that.groupRowId,_that.groupName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int rowId,  int? userRowId,  String title,  String? description,  String? eventType,  String? color,  String startDate,  String endDate,  String? isAllDay,  int? labelRowId,  String? labelName,  String? labelColor,  String? location,  String? rrule,  int? groupRowId,  String? groupName)?  $default,) {final _that = this;
switch (_that) {
case _CalendarEvent() when $default != null:
return $default(_that.rowId,_that.userRowId,_that.title,_that.description,_that.eventType,_that.color,_that.startDate,_that.endDate,_that.isAllDay,_that.labelRowId,_that.labelName,_that.labelColor,_that.location,_that.rrule,_that.groupRowId,_that.groupName);case _:
  return null;
...
class _CalendarEvent implements CalendarEvent {
  const _CalendarEvent({required this.rowId, this.userRowId, required this.title, this.description, this.eventType, this.color, required this.startDate, required this.endDate, this.isAllDay, this.labelRowId, this.labelName, this.labelColor, this.location, this.rrule, this.groupRowId, this.groupName});
