...
@useResult
$Res call({
 int rowId, int? userRowId, int? categoryRowId, String? categoryName, String? categoryIcon, String? categoryColor, int? assetRowId, String? assetName, String expenseType, int amount, String? description, String? expenseDate, String? merchant, String? paymentMethod, int? installmentMonths, int? refundOfExpenseRowId, double? originalAmount, String? originalCurrency, double? exchangeRate, String? autoSource, int? calendarEventRowId, int? todoRowId, List<int> splitCategoryRowIds, String? createAt, String? modifyAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int rowId,  int? userRowId,  int? categoryRowId,  String? categoryName,  String? categoryIcon,  String? categoryColor,  int? assetRowId,  String? assetName,  String expenseType,  int amount,  String? description,  String? expenseDate,  String? merchant,  String? paymentMethod,  int? installmentMonths,  int? refundOfExpenseRowId,  double? originalAmount,  String? originalCurrency,  double? exchangeRate,  String? autoSource,  int? calendarEventRowId,  int? todoRowId,  List<int> splitCategoryRowIds,  String? createAt,  String? modifyAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Expense() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int rowId,  int? userRowId,  int? categoryRowId,  String? categoryName,  String? categoryIcon,  String? categoryColor,  int? assetRowId,  String? assetName,  String expenseType,  int amount,  String? description,  String? expenseDate,  String? merchant,  String? paymentMethod,  int? installmentMonths,  int? refundOfExpenseRowId,  double? originalAmount,  String? originalCurrency,  double? exchangeRate,  String? autoSource,  int? calendarEventRowId,  int? todoRowId,  List<int> splitCategoryRowIds,  String? createAt,  String? modifyAt)  $default,) {final _that = this;
switch (_that) {
case _Expense():
return $default(_that.rowId,_that.userRowId,_that.categoryRowId,_that.categoryName,_that.categoryIcon,_that.categoryColor,_that.assetRowId,_that.assetName,_that.expenseType,_that.amount,_that.description,_that.expenseDate,_that.merchant,_that.paymentMethod,_that.installmentMonths,_that.refundOfExpenseRowId,_that.originalAmount,_that.originalCurrency,_that.exchangeRate,_that.autoSource,_that.calendarEventRowId,_that.todoRowId,_that.splitCategoryRowIds,_that.createAt,_that.modifyAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int rowId,  int? userRowId,  int? categoryRowId,  String? categoryName,  String? categoryIcon,  String? categoryColor,  int? assetRowId,  String? assetName,  String expenseType,  int amount,  String? description,  String? expenseDate,  String? merchant,  String? paymentMethod,  int? installmentMonths,  int? refundOfExpenseRowId,  double? originalAmount,  String? originalCurrency,  double? exchangeRate,  String? autoSource,  int? calendarEventRowId,  int? todoRowId,  List<int> splitCategoryRowIds,  String? createAt,  String? modifyAt)?  $default,) {final _that = this;
switch (_that) {
case _Expense() when $default != null:
return $default(_that.rowId,_that.userRowId,_that.categoryRowId,_that.categoryName,_that.categoryIcon,_that.categoryColor,_that.assetRowId,_that.assetName,_that.expenseType,_that.amount,_that.description,_that.expenseDate,_that.merchant,_that.paymentMethod,_that.installmentMonths,_that.refundOfExpenseRowId,_that.originalAmount,_that.originalCurrency,_that.exchangeRate,_that.autoSource,_that.calendarEventRowId,_that.todoRowId,_that.splitCategoryRowIds,_that.createAt,_that.modifyAt);case _:
  return null;
