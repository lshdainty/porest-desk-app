...
/// 합계·예산·통계·카드 청구에서 삭제와 똑같이 빠지고, 내역·검색에는 남는다.
 ...
 int? get refundTransferRowId;/// 이 저장이 **방금 만든** 카드 환급액 (null = 없음).
///
