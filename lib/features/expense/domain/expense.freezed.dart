...
/// 화면이 "결제계좌로 N원이 환급됐어요" 를 말할 재료다(설계 13-1).
 int? get refundedAmount;/// 원 통화 금액 (해외 결제). null 이면 원화 결제 — amount 가 곧 결제액이다.
