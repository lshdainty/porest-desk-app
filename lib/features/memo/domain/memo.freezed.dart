...
mixin _$Memo {
 ...
 int get rowId; int? get userRowId; String? get title; String? get content; String? get tag;// 분류 태그 (가계부/자산/업무/개인/건강/결제/고정비 등)
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,rowId,userRowId,title,content,tag,color,isPinned,createAt,modifyAt);

@override
String toString() {
  return 'Memo(rowId: $rowId, userRowId: $userRowId, title: $title, content: $content, tag: $tag, color: $color, isPinned: $isPinned, createAt: $createAt, modifyAt: $modifyAt)';
}
...
@useResult
$Res call({
 int rowId, int? userRowId, String? title, String? content, String? tag, String? color, String? isPinned, String? createAt, String? modifyAt
});
...
/// Create a copy of Memo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? rowId = null,Object? userRowId = freezed,Object? title = freezed,Object? content = freezed,Object? tag = freezed,Object? color = freezed,Object? isPinned = freezed,Object? createAt = freezed,Object? modifyAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int rowId,  int? userRowId,  String? title,  String? content,  String? tag,  String? color,  String? isPinned,  String? createAt,  String? modifyAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Memo() when $default != null:
return $default(_that.rowId,_that.userRowId,_that.title,_that.content,_that.tag,_that.color,_that.isPinned,_that.createAt,_that.modifyAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int rowId,  int? userRowId,  String? title,  String? content,  String? tag,  String? color,  String? isPinned,  String? createAt,  String? modifyAt)  $default,) {final _that = this;
switch (_that) {
case _Memo():
return $default(_that.rowId,_that.userRowId,_that.title,_that.content,_that.tag,_that.color,_that.isPinned,_that.createAt,_that.modifyAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int rowId,  int? userRowId,  String? title,  String? content,  String? tag,  String? color,  String? isPinned,  String? createAt,  String? modifyAt)?  $default,) {final _that = this;
switch (_that) {
case _Memo() when $default != null:
return $default(_that.rowId,_that.userRowId,_that.title,_that.content,_that.tag,_that.color,_that.isPinned,_that.createAt,_that.modifyAt);case _:
  return null;
...
class _Memo implements Memo {
  const _Memo({required this.rowId, this.userRowId, this.title, this.content, this.tag, this.color, this.isPinned, this.createAt, this.modifyAt});
...
/// Create a copy of Memo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? rowId = null,Object? userRowId = freezed,Object? title = freezed,Object? content = freezed,Object? tag = freezed,Object? color = freezed,Object? isPinned = freezed,Object? createAt = freezed,Object? modifyAt = freezed,}) {
  return _then(_Memo(
rowId: null == rowId ? _self.rowId : rowId // ignore: cast_nullable_to_non_nullable
as int,userRowId: freezed == userRowId ? _self.userRowId : userRowId // ignore: cast_nullable_to_non_nullable
as int?,title: freezed == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
