...
///
/// 네 칸을 따로 두지 않고 **가장 최근 것 하나**만 든다. 넷은 통계 화면이 한 번에
/// 읽고([invalidateAfterExpenseChange] · 당겨서 새로고침 · 진입 갱신 모두 넷을
/// 함께 민다) 무효화도 넷을 함께 하므로, 사실상 한 묶음으로 움직인다. 아직 한 번도
/// 안 받은 것(예: 열어 본 적 없는 탭)은 여기 안 남는데, 안 읽힌 provider 를 비우는
